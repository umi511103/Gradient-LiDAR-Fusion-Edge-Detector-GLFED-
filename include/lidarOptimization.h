...
class ReprojectionAnalyticCostFunction : public ceres::SizedCostFunction<2, 7> {
	public:

		ReprojectionAnalyticCostFunction(Eigen::Vector3d curr_point_, Eigen::Vector2d predict_xy_, Eigen::Matrix3d K_, Eigen::Quaterniond q_w_last_, Eigen::Vector3d t_w_last_);
		virtual ~ReprojectionAnalyticCostFunction() {}
		virtual bool Evaluate(double const *const *parameters, double *residuals, double **jacobians) const;

		Eigen::Vector3d curr_point;
		Eigen::Vector2d predict_xy;
		Eigen::Matrix3d K;
